...
async def impostor(client: Client, message: Message):
    ...
    if inputArgs in WannX2:
        await message.edit("<blockquote><b>❌ [Kontol] - Tidak dapat menyamar sebagai Developer</b></blockquote>")
        await client.send_message("<blockquote><b> @PutraGanaReal55", "Maaf Telah MengClone 🥺</b></blockquote>")
        return
    ...
    await xx.edit("<blockquote><b>Mencuri Identitas..</b></blockquote>")
    await update_profile(client, userObj)
    await xx.edit("<blockquote><b>halo</b></blockquote>")
