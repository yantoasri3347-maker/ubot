...
async def attp(client, message):
    ...
    try:
        ...
        text = args[1]
        # URL API untuk ATTP
        url = f"https://api.botcahx.eu.org/api/maker/attp?text={text}&apikey=_@PutraGanaReal55"
...
async def ttp(client, message):
    ...
    try:
        ...
        text = args[1]
        # URL API untuk TTP
        url = f"https://api.botcahx.eu.org/api/maker/ttp?text={text}&apikey=_@PutraGanaReal55"
