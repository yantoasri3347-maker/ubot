...
__HELP__ = """⪼ Dokumen untuk Streaming

<blockquote>Memulai streaming audio.
<code>{0}play  (judul/balas media/link)</code></blockquote>
<blockquote>Memulai Streaming Video.
<code>{0}vplay  (judul/balas media/link)</code></blockquote>
<blockquote>Menghentikam Streaming.
<code>{0}end</code></blockquote>
<blockquote>Menjeda Streaming.
<code>{0}pause</code></blockquote>
<blockquote>Melanjutkan Streaming yang dijeda.
<code>{0}resume</code></blockquote>
"""
