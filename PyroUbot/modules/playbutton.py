...
async def _(client, message):
    ...
    if len(args) < 2:
        await message.reply_text("contoh : .ytgold _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .ytsilver _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .iggold _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .igsilver _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .fbsilver _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .fbgold _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .twtsilver _@PutraGanaReal55")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .twtgold _@PutraGanaReal55")
        return
